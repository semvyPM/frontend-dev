  ...
  data() {
    return {
      floorData: {
        ...
        floorMainData: {heightFloor: '3', perimetrOuterWalls: '30', baseArea: '56', thicknessOuterWalls: '', lengthInnerWalls: '15', thicknessInnerWalls: ''},
        itemsWindow: [{ heightWindow: '1.5', widthWindow: '1.5', quantityWindow: '5' }],
        itemsDoorsOut: [{ heightDoorsOut: '2.1', widthDoorsOut: '1', quantityDoorsOut: '1' }],
        itemsDoorsInner: [{ heightDoorsInner: '2', widthDoorsInner: '0.8', quantityDoorsInner: '5' }],
        osbInnerOvarlap: '',
